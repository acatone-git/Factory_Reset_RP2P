...
- Now Navigate to the "Tools" Folder & install the [ADB & Fastboot++](https://github.com/K3V1991/ADB-and-FastbootPlusPlus/releases) bundle (ADB-and-Fastboot++_v1.0.5.exe)
